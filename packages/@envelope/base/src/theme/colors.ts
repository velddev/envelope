...
export const colors = {
  ...
  bgDark: {
    100: transparentize("20, 21, 32", 1.0),
    80: transparentize("20, 21, 32", 0.8),
    60: transparentize("20, 21, 32", 0.6),
    40: transparentize("20, 21, 32", 0.4),
    20: transparentize("20, 21, 32", 0.2),
    10: transparentize("20, 21, 32", 0.1),
    5: transparentize("20, 21, 32", 0.05),
  },
  bg2Light: {
    100: "rgb(242, 242, 242)",
